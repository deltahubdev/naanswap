...
import "../naanswap/interfaces/INaanSwapRouter.sol";
import "../naanswap/interfaces/IERC20.sol";
import "../naanswap/interfaces/IWETH.sol";
import "../naanswap/interfaces/INaanSwapFactory.sol";
import "../naanswap/interfaces/INaanSwapPair.sol";
import "../naanswap/libraries/SafeMath.sol";

contract NaanSwapBatchTrade {
    using SafeMath for uint256;
    INaanSwapFactory public factory = INaanSwapFactory(0x75e48C954594d64ef9613AeEF97Ad85370F13807);
    INaanSwapRouter public router = INaanSwapRouter(0x9C578b573EdE001b95d51a55A3FAfb45f5608b1f);
    address public weth = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;

    // constructor(address _router, address _weth, address _factory) public {
    //     router = INaanSwapRouter(_router);
    //     weth = _weth;
    //     factory = INaanSwapFactory(_factory);
    // }
        ...
        )
    {
        ...
        address stoken = INaanSwapPair(pair).stoken();
